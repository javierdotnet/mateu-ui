 ...
 * @since JavaFX 2.2
 */
public class MateuDataColumnTreeTableCell<S,T> extends TreeTableCell<S,T> {
    ...
    public static <S,T> Callback<TreeTableColumn<S,T>, TreeTableCell<S,T>> forTreeTableColumn(final StringConverter<T> converter, String colId, ActionOnRow action, CellStyleGenerator cellStyleGenerator) {
        return new Callback<TreeTableColumn<S,T>, TreeTableCell<S,T>>() {
            @Override public TreeTableCell<S,T> call(TreeTableColumn<S,T> list) {
                return new MateuDataColumnTreeTableCell<S,T>(converter, colId, action, cellStyleGenerator);
            }
        };
    }
     ...
     */
    public MateuDataColumnTreeTableCell(final StringConverter<T> converter, String colId, ActionOnRow action, CellStyleGenerator cellStyleGenerator) {
        ...
        hyperlink.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                action.run(((DataStore)getTreeTableRow().getItem()).get(colId));
            }
