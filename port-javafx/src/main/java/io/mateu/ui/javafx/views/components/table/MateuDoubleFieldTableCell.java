 ...
 * @since JavaFX 2.2
 */
public class MateuDoubleFieldTableCell<S,T> extends TableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(
        ...
        return list -> new MateuDoubleFieldTableCell<S,T>(converter);
    }
     ...
     */
    public MateuDoubleFieldTableCell() {
        this(null);
    }
     ...
     *      type T.
     */
    public MateuDoubleFieldTableCell(StringConverter<T> converter) {
