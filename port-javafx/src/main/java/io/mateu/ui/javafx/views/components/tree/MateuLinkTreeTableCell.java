 ...
 * @since JavaFX 2.2
 */
public class MateuLinkTreeTableCell<S,T> extends TreeTableCell<S,T> {
    ...
    public static <S,T> Callback<TreeTableColumn<S,T>, TreeTableCell<S,T>> forTreeTableColumn(final StringConverter<T> converter, ActionOnRow action, CellStyleGenerator cellStyleGenerator) {
        return new Callback<TreeTableColumn<S,T>, TreeTableCell<S,T>>() {
            @Override public TreeTableCell<S,T> call(TreeTableColumn<S,T> list) {
                return new MateuLinkTreeTableCell<S,T>(converter, action, cellStyleGenerator);
            }
        };
    }
     ...
     */
    public MateuLinkTreeTableCell(final StringConverter<T> converter, ActionOnRow action, CellStyleGenerator cellStyleGenerator) {
        ...
        hyperlink.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                action.run((Data)getTreeTableRow().getItem());
            }
