    ...
    public class SampleApp extends BaseServerSideApp implements ServerSideApp {
        ...
        @Override
        public UserData signUp(String login, String name, String email, String password) throws Throwable {
            return null;
        }

        @Override
        public String recoverPassword(String loginOrPassword) throws Throwable {
            return null;
        }
