 ...
 * @since JavaFX 2.2
 */
public class MateuDataColumnTableCell<S,T> extends TableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(final StringConverter<T> converter, String colId, ActionOnRow action, CellStyleGenerator cellStyleGenerator) {
        return new Callback<TableColumn<S,T>, TableCell<S,T>>() {
            @Override public TableCell<S,T> call(TableColumn<S,T> list) {
                return new MateuDataColumnTableCell<S,T>(converter, colId, action, cellStyleGenerator);
            }
        };
    }
     ...
     */
    public MateuDataColumnTableCell(final StringConverter<T> converter, String colId, ActionOnRow action, CellStyleGenerator cellStyleGenerator) {
        ...
        hyperlink.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                action.run(((DataStore)getTableRow().getItem()).getData().get(colId));
            }
