...
CREATE TABLE Customer(ID INTEGER IDENTITY PRIMARY KEY,FirstName VARCHAR(20),LastName VARCHAR(30),Street VARCHAR(50),City VARCHAR(25));
CREATE TABLE Product(ID INTEGER IDENTITY PRIMARY KEY,Name VARCHAR(30),Price DECIMAL);
CREATE TABLE Invoice(ID INTEGER IDENTITY PRIMARY KEY,CustomerID INTEGER,Total DECIMAL, FOREIGN KEY (CustomerId) REFERENCES Customer(ID) ON DELETE CASCADE);
...
CREATE TABLE Currency(ID VARCHAR(30) PRIMARY KEY,Name VARCHAR(30),Decimals INTEGER);
INSERT INTO Currency VALUES('EUR','Euro',2);
INSERT INTO Currency VALUES('USD','US Dollars',2);
INSERT INTO Currency VALUES('GBP','GB Pounds',2);
