...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        date.setDefaultValue(LocalDate.now()); // valor que sale cuando aparece el calendario

        date.setAssistiveText("Texto asistencia"); // esto parece que no sale por ningún lado
        ...
        button.addClickListener(e -> {
            layout.addComponent(new Label("Thanks " + name.getValue() + " / " + date.getValue()
                    + ", it works!"));
        });
