 ...
 * {@link #MateuCheckBoxTableCell(Callback, StringConverter)} constructor.
 *
 ...
 * @since JavaFX 2.2
 */
public class MateuCheckBoxTableCell<S,T> extends TableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(
        ...
        return list -> new MateuCheckBoxTableCell<S,T>(getSelectedProperty, converter);
    }
    ...
    public MateuCheckBoxTableCell(
        ...
        focusedProperty().addListener(new ChangeListener<Boolean>() {
            ...
            public void changed(ObservableValue<? extends Boolean> arg0,
                ...
                if (arg2) {
                    System.out.println("checkbox focused!!!");
                    ...
                    System.out.println("checkbox not focused!!!");
        ...
        checkBox.setOnKeyPressed(new EventHandler<KeyEvent>() {
            @Override public void handle(final KeyEvent t) {
                if (t.getCode() == KeyCode.ESCAPE) {
                    ...
                    commitEdit((T) new Boolean(!checkBox.isSelected()));
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ((TableCellSkin)getSkin()).getBehavior().traverseNext();
