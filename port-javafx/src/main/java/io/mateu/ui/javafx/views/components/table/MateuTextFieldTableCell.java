 ...
 * @since JavaFX 2.2
 */
public class MateuTextFieldTableCell<S,T> extends TableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(
        ...
        return list -> new MateuTextFieldTableCell<S,T>(converter);
    }
     ...
     */
    public MateuTextFieldTableCell() {
        this(null);
    }
     ...
     *      type T.
     */
    public MateuTextFieldTableCell(StringConverter<T> converter) {
